  ...
  <div v-if="cast" class="c-weather">
    ...
    <div class="c-weather__temp">
      ...
      <div class="c-weather__temp-details">
        <img src="../assets/img/menu-up.svg">{{ cast.temp_max | round }}&#8451;

        <img src="../assets/img/menu-down.svg">{{ cast.temp_min | round }}&#8451;
  ...
  export default class CastComponent extends Vue {
    ...
    private async getCast() {
      try {
        ...
        const { data: { main } } = await axios.get(url, {
          params
        })
        this.cast = main
      } catch (e) {
